#!/bin/bash
## setup command=wget -q --no-check-certificate https://raw.githubusercontent.com/speedy005/Filmon/main/installer.sh -O - | /bin/sh
...
wget --no-check-certificate 'https://github.com/speedy005/Filmon/archive/refs/heads/main.tar.gz' -O "$FILEPATH" || {
